...
const inputDir = args.input || 'videos';
const outputDir = args.output || 'data/gifs';
...
console.log('');
console.log(`Done. Created ${manifest.length} GIF files.`);
